...
export interface WatchItem{revision?:number;isWeeklyFocus?:boolean;images?:PostImage[];symbol:string;name:string;market:string;stage:Stage;thesis:string;invalidation:string;createdAt?:string;updatedAt:string;articleSlug:string}
