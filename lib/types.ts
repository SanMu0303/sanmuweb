...
export interface Article{slug:string;title:string;/** Optional neutral topic shown before a member content gate. */publicTitle?:string;excerpt:string;preview?:string;category:Category;tags:string[];publishedAt:string;pinned:boolean;access:'public'|'member'|'preview';readMinutes:number;sections:{heading:string;text:string}[]}
