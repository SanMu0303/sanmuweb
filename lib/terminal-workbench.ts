...
export type Preferences = {splitRatio:number; volume:number; sound:boolean; panelSound:Record<Panel,boolean>};
...
export const defaultPreferences:Preferences = {splitRatio:.38,volume:.35,sound:false,panelSound:{market:true,selected:true,smart:true}};
